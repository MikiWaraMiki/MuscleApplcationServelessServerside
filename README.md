...
This is a sample template for todo_get_query - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name todo_get_query --tail
```
...
```bash
aws cloudformation delete-stack --stack-name todo_get_query
```
